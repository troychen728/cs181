...
public class WordCountMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
	    ...
	    /** Because the pattern only recognize those start with a to z, all punctuation is handled, since no punctuation starts with a character. **/ 
	    public static final String[] Stopwordsarray = new String[] { "a", "about", "above", "above", "across", "after", "afterwards", "again", 
	    		"against", "all", "almost", "alone", "along", "already", "also","although","always","am","among", "amongst", "amoungst", "amount",  
	    		"an", "and", "another", "any","anyhow","anyone","anything","anyway", "anywhere", "are", "around", "as",  "at", "back","be","became",
	    		"because","become","becomes", "becoming", "been", "before", "beforehand", "behind", "being", "below", "beside", "besides", "between",
	    		...
	    		"nowhere", "of", "off", "often", "on", "once", "one", "only", "onto", "or", "other", "others", "otherwise", "our", "ours", "ourselves",
	    		...
	    		"thickv", "thin", "third", "this", "those", "though", "three", "through", "throughout", "thru", "thus", "to", "together", "too", 
	    ...
	    public static final List<String> Stopwords = Arrays.asList(Stopwordsarray);
